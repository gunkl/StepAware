...
#if __has_include("build_number.h")
#include "build_number.h"  // Auto-generated by scripts/increment_build.py
#else
#define BUILD_NUMBER "0000" // Fallback for native test / CI without a prior esp32c3 build
#endif
